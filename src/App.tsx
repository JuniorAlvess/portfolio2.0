    ...
    <div ref={container} className="container">
      <nav className={activeMenuMobile ? "side-menu active" : "side-menu"}>
        <ul>
          <li>
            <a href="#work">
              <span>Work</span> <IoMdCodeWorking className="icon-menu" />
            </a>
          </li>
          <li>
            <a href="#resume">
              <span>Resume</span> <CgUser className="icon-menu" />
            </a>
          </li>
          <li>
            <a href="#contact">
              <span>Contact</span>
              <BiMessageSquareDetail className="icon-menu" />
            </a>
          </li>
          <li>
            <a
              href="https://www.linkedin.com/in/ejalves/"
              target="_blank"
              rel="noreferrer"
            >
              <span>Linkedin</span> <RiLinkedinLine className="icon-menu" />
            </a>
          </li>
          <li>
            <a
              href="https://github.com/JuniorAlvess"
              target="_blank"
              rel="noreferrer"
            >
              <span>GitHub</span> <FiGithub className="icon-menu" />
            </a>
          </li>
          <li>
            <a
              href="https://web.whatsapp.com/send?phone=5511930197938"
              target="_blank"
              rel="noreferrer"
            >
              <span>WhatsApp</span> <AiOutlineWhatsApp className="icon-menu" />
            </a>
          </li>
          <li onClick={() => setActiveMenuMobile(!activeMenuMobile)}>
            <FiPlusCircle
              className={activeMenuMobile ? "icon-menu active" : "icon-menu"}
            />
          </li>
        </ul>
      </nav>
      ...
      <header id="home">
        <nav>
          <ul
            style={
              window.matchMedia("(max-width: 790px)").matches && scroll > 10
                ? {
                    filter: "drop-shadow(1rem 0 0.75rem var(--third-color))",
                    zIndex: 2,
                  }
                : undefined
            }
        ...
        <section>
          ...
          <article>
            <h1>
              Hi, I'm Junior and I'm a <strong>Frontend Developer</strong>.
            </h1>
            <p>
              I am a developer with startup experience. My main stack is
              TypeScript, React.js, NextJs, Sass, GraphQL.
            </p>
            <button
              title="Contact me"
              role="Contact me"
      ...
      <main>
        <section className="work">
          ...
          <div className="filter-projects">
            <button
              disabled={filteredProjects === "all"}
              onClick={() => setFilteredProjects("all")}
            >
              All ({projects.length})
            </button>
            {techsFiltered.map((tech) => (
              <button onClick={() => setFilteredProjects(tech)}>
                {techs.filter((e, i) => techs.indexOf(tech) === i) && tech} (
                {techs.filter((t) => t === tech).length})
              </button>
            ))}
          </div>
                ...
                project.techs.map(
                  (tech) =>
                    tech.tech.toLocaleLowerCase() ===
                      filteredProjects.toLocaleLowerCase() && (
                      <Project key={index} project={project} />
                    )
                )
              )
        ...
        <section className="resume">
          ...
          <p>
            Passionate Frontend Developer with a keen interest in technology and
            innovation, boasting 3 years of experience in web development.
            Demonstrated ability to excel in challenging projects and
            effectively collaborate within multidisciplinary teams. Main stack
            includes TypeScript, React.js, Next.js, and GraphQL.
            <br />
            Recent experience involves maintenance and development of e-commerce
            on the VTEX platform for Carrefour, where I worked for one year
            utilizing TypeScript, React.js, Next.js, tailwind, VtexIO,
            FastStore, and GraphQL.
          </p>
          ...
          <section>
            ...
            <ol>
              ...
              <ul>
                ...
                <li>
                  <a href="https://vtex.com/" rel="noreferrer" target="_blank">
                    Vtex
                  </a>
                </li>
                <li>
                  <a
                    href="https://vtex.com/br-pt/vtex-io/"
                    rel="noreferrer"
                    target="_blank"
                  >
                    VtexIO
          ...
          <a href="/assets/ednaldo_alves_resume.pdf" download>
            Download CV (PDF)
          </a>
        </section>
        <section>
      ...
      <div className="cursor" ref={followingCursor}></div>
